...
#define integer       _lapack_integer
#define real          _lapack_real
#define doublereal    _lapack_doublereal
#define complex       _lapack_complex
#define doublecomplex _lapack_doublecomplex
#define logical       _lapack_logical
