...
void main( )
{
    ...
    //coordinate = vec2( 1.0 - texturecoordinate.x, 1.0 - texturecoordinate.y );
}
...
void main( )
{
    ...
    //gl_FragColor = vec4( 0.5, 0.5, 0.5, 0.5 );//texture2D( videoframe, coordinate );
    //gl_FragColor = texture2D( videoframe, vec2( 1.0 - coordinate.x, 1.0 - coordinate.y ) );
}
