...
-(id) initWithFrame:(CGRect)frame context:(EAGLContext *)context{
    ...
    if (self) {
        ...
        sphere = [[Sphere alloc] init:480 slices:480 radius:1.0 textureFile:nil];
        meridians = [[Sphere alloc] init:480 slices:480 radius:.80 textureFile:@"equirectangular-projection-lines.png"];
    }
    return self;
}
